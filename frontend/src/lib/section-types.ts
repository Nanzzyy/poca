...
export const SECTION_TYPES: Record<string, SectionTypeDef> = {
  ...
  "info-cards": {
    ...
    fields: [
      {
        key: "cards", type: "card[]", label: "Cards", max: 6,
        item_fields: [
  ...
  timeline: {
    ...
    fields: [
      ...
      {
        key: "items", type: "timeline-item[]", label: "Timeline Items",
        item_fields: [
  ...
  "guide-cards": {
    ...
    fields: [
      {
        key: "cards", type: "guide-card[]", label: "Guide Cards", max: 4,
        item_fields: [
...
export const ICON_OPTIONS = [
  "clock", "dollar", "map-pin", "star", "info", "sun", "moon", "cloud",
  "umbrella", "shirt", "camera", "compass", "map", "phone", "mail",
  "globe", "heart", "shield", "zap", "award", "users", "home",
];
