...
const cardImg = (item: Destination) => destImage(item.images, item.name);
              ...
              >
                ...
                <div className="p-4">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="text-secondary font-bold">{item.price_level || "—"}</span>
                  </div>
                  <p className="text-[14px] text-on-surface-variant line-clamp-2">{item.description || "Rekomendasi pilihan Poca AI untukmu."}</p>
